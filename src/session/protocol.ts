...
/** The chosen chars + 10 constructs from the ranking flow (see the store's Grid10), shared so an
 *  observer's matrices can label the constructs. */
...
export interface BoardSnapshot {
  ...
  /** The chosen chars + constructs, or null before the ranking flow finishes. */
